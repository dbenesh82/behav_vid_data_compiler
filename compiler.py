...
# loop over the directories with txt files and use these functions to create a master data frame

# current working dir
cwd = Path.cwd()

# check if folder correct
if cwd.stem != "data":
    print("wrong folder")
else:
    # get all the directories in the data folder
    dirs = [x for x in cwd.iterdir() if x.is_dir()]
...
# write to file       
master_df.to_csv("behav_combined_out.csv")
